 ...
 */
    ...
    * @return 
    */
    public int NumerosAleatorios(int n1, int n2)
    {
        return (int)Math.floor((Math.random()*(n2-n1+1) + n1));
    }
    /**
     * 
     * @param evt realiza quiniela 
     */
